...
from schemas import IntentTextSchema, AwakeRequestSchema, IncreaseDecreaseSchema
...
intent_classification_security_manager = None
...
def send_heartbeats():
    ...
    '''
    global intent_classification_security_manager, SERVICE_NAME, SERVICE_HOST, SERVICE_KEY, SERVICE_PORT, CACHE_SERVICES
    ...
    while True:
        ...
        service_hmac = intent_classification_security_manager._SecurityManager__encode_hmac(test_json)
        try:
            # Sending the request.
            response = requests.get(
                f"http://{SERVICE_HOST}:{SERVICE_PORT}/intent",
                json = test_json,
...
def awake():
    global intent_classification_security_manager, SERVICE_NAME, SERVICE_HOST, SERVICE_KEY, SERVICE_PORT, CACHE_SERVICES, DATA_WAREHOUSE_DATA
    ...
    if check_response != "OK":
        ...
        if status_code != 200:
            ...
            intent_classification_security_manager = SecurityManager(result["security"]["secret_key"])
...
def serve():
    global intent_classification_security_manager, SERVICE_NAME, SERVICE_HOST, SERVICE_KEY, SERVICE_PORT, DATA_WAREHOUSE_DATA
    ...
    if check_response != "OK":
        ...
        if status_code != 200:
            ...
            service_hmac = intent_classification_security_manager._SecurityManager__encode_hmac(result)
...
def increase():
    global intent_classification_security_manager, SERVICE_NAME, SERVICE_HOST, SERVICE_KEY, SERVICE_PORT
